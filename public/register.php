...
<div class="auth-card">
  ...
  <h2 class="text-center mb-1" style="font-family:'Sora',sans-serif;font-size:22px;font-weight:700;color:var(--text-primary)">Create your account</h2>
  <p class="text-center mb-4" style="font-size:14px;color:var(--text-secondary)">Start tracking your job search today</p>
  ...
  <form method="POST">
    ...
    <button type="submit" class="btn btn-primary w-100" style="padding:12px;font-weight:600;">Create Account</button>
  </form>

  <p class="text-center mt-4 mb-0" style="font-size:13px">
    Already have an account? <a href="<?= APP_URL ?>/login.php" class="text-decoration-none" style="color:var(--brand);font-weight:600">Sign in</a>
  </p>
</div>
